...
and I filed with Mozilla: Bug 1944926 [https://bugzilla.mozilla.org/show_bug.cgi?id=1944926] - "Executing arbitrary JavaScript from third-party origin when processing HTTP Basic Auth." And yes: **no CVE**. (which we do not agree with)
